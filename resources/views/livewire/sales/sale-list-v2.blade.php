                        ...
                        <div class="table-responsive">
                            <table id="salesList" class="table table-striped table-bordered nowrap" cellspacing="0"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($customer_ledger as $sales)
                                        ...
                                        <tr>
                                            ...
                                            {{-- Discount --}}
                                            <td class="text-right">
                                                {{ $sales->price_discount ? number_format($sales->price_discount) . '/=' : '' }}
                                            </td>

                                            {{-- VAT --}}
                                            <td class="text-right">
                                                {{ $sales->vat ? number_format($sales->vat) . '/=' : '' }}</td>

                                            {{-- Carring --}}
                                            <td class="text-right">
                                                {{ $sales->carring ? number_format($sales->carring) . '/=' : '' }}</td>

                                            {{-- Others --}}
                                            <td class="text-right">
                                                {{ $sales->other_charge ? number_format($sales->other_charge) . '/=' : '' }}
                                            </td>
                                ...
                                <tfoot>
                                    ...
                                    <th class="text-right">{{formatAmount($g_total_summary['totalDiscount'] ?? 0)}}/=
                                    </th>
                                    <th class="text-right">{{formatAmount($g_total_summary['totalVAT'] ?? 0)}}/=</th>
                                    <th class="text-right">{{formatAmount($g_total_summary['totalCarring'] ?? 0)}}/=
                                    </th>
