@section('page-title', 'Expense Category Add')

<div class="col-md-12 col-sm-12 ">
    <div class="x_panel p-3">
        <div class="x_title">
            <div class="header-title d-flex align-items-center gap-2">
                <h2 class="mr-auto">Add Expense Category</h2>
        ...
        <div class="x_content">
            ...
            <form wire:submit.prevent="create()" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" style="max-width: 500px; margin: 0 auto;">
                @csrf
                @if ($errors->any())
