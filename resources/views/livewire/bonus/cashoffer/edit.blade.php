@section('page-title', 'Edit Cash Offer')

<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title p-3">
            <div class="header-title d-flex justify-content-start  gap-1">
                <h2 class="mr-2">Edit Cash Offer</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $offer->supplier->company_name }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label class="d-block border py-1 px-2 add_payment_lebel" for="supplier_name">Address</label>
                            <input type="text" class="form-control" value="{{ $offer->supplier->address }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label class="d-block border py-1 px-2 add_payment_lebel" for="supplier_name">Mobile</label>
                            <input type="text" class="form-control" value="{{ $offer->supplier->mobile }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="amount" id="amount" class="form-control text-right">
                        </div>
                    </div>
                </div>
