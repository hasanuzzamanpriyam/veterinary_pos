    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="header-title d-flex align-items-center gap-2 p-3">
                <h2 class="mr-auto">Monthly Summary Report</h2>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="daily-summary-sales-report-area mt-4">
                            <div class="x_title">
                                <h4 class="text-center"> <strong>Monthly Sales Report in <span
                                            class="text-dark">{{$month_name}}</span></strong></h4>
                            </div>
                            @if($sales)
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="daily-summary-sales-report-area mt-4">
                            <div class="x_title">
                                <h4 class="text-center"> <strong>Monthly Purchase Report in <span
                                            class="text-dark">{{$month_name}}</span></strong></h4>
                            </div>
                            @if($purchase)
                                <table class="table table-striped table-bordered">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="daily-summary-sales-report-area mt-4">
                            <div class="x_title">
                                <h4 class="text-center"> <strong>Monthly Collection Report in <span
                                            class="text-dark">{{$month_name}}</span></strong></h4>
                            </div>
                            @if($collection)
                                <table class="table table-striped table-bordered">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="daily-summary-sales-report-area mt-4">
                            <div class="x_title">
                                <h4 class="text-center"> <strong>Monthly Payment Report in <span
                                            class="text-dark">{{$month_name}}</span></strong></h4>
                            </div>
                            @if($payment)
                                <table class="table table-striped table-bordered">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="x_title">
                            <h4 class="text-center"> <strong>Monthly Expense Report in <span
                                        class="text-dark">{{$month_name}}</span></strong></h4>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Monthly Salary Expense Report in <span
                                                class="text-dark">{{$month_name}}</span></strong></h4>
                                </div>
                                @if($salary)
                                    <table class="table table-striped table-bordered">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Monthly Bank Expense Report in <span
                                                class="text-dark">{{$month_name}}</span></strong></h4>
                                </div>
                                @if($bank)
                                    <table class="table table-striped table-bordered">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Monthly Labour Expense Report in <span
                                                class="text-dark">{{$month_name}}</span></strong></h4>
                                </div>
                                @if($labour)
                                    <table class="table table-striped table-bordered">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Monthly Carring Expense Report in <span
                                                class="text-dark">{{$month_name}}</span></strong></h4>
                                </div>
                                @if($carring)
                                    <table class="table table-striped table-bordered">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Monthly Dokan Expense Report in <span
                                                class="text-dark">{{$month_name}}</span></strong></h4>
                                </div>
                                @if($dokan)
                                    <table class="table table-striped table-bordered">
