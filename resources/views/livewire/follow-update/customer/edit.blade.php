...
@section('page-title', 'Update Customer Following Date')
...
<div class="col-md-12 col-sm-12 d-flex flex-column justify-content-center ">
    <div class="x_panel">
        ...
        <div class="x_content p-3">
            <form  wire:submit.prevent="updateCustomerFollowUpdate()" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
