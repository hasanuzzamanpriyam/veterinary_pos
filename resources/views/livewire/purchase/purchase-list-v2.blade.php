                            ...
                            <tbody>
                                ...
                                @foreach($supplier_ledger as $purchase)
                                    ...
                                    <tr>
                                        ...
                                        {{-- Transport Info --}}
                                        <td class="text-left">
                                            {{$purchase->transport_no}}{{$purchase->delivery_man ? ", " . $purchase->delivery_man : ''}}
                                        </td>
                                        ...
                                        <td class="text-left">
                                            @foreach ($filtered_products as $product)
                                                @if($product->product)
                                                    @php
                                                        $type = $product->product->size->name;
                                        ...
                                        {{-- Discount --}}
                                        <td class="text-right">
                                            {{$purchase->price_discount ? formatAmount($purchase->price_discount) . '/=' : ''}}
                                        </td>

                                        {{-- Purchase Tk --}}
                                        <td class="text-right">
                                            {{formatAmount($purchase->total_price - $purchase->price_discount)}}/=
                                        </td>
