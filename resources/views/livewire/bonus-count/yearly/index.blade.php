@section('page-title', 'Yearly Bonus Count Add')
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title p-3">
            <div class="header-title d-flex align-items-center gap-2">
                <h2>Yearly Bonus Count Add</h2>
                <a href="{{route('yearly.bonus.index')}}" class="mr-auto ml-3 cursor-pointer" onclick="history.back()"><i class="fa fa-close"></i></a>
            </div>
        </div>
                                ...
                                <div class="row" id="row_{{$i}}">
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="yearly_bonus.{{$i}}.from" value="" class="form-control text-right">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="yearly_bonus.{{$i}}.to"  value="" class="form-control text-right">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="py-1 border entry-lebel sales_entry_lebel d-none" for="rate">Bonus Rate:</label>
                                            <input type="text"  wire:model="yearly_bonus.{{$i}}.rate"  value="" class="form-control text-right">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-12">
