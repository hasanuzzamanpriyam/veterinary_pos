@section('page-title', 'Yearly Bonus Count List')
    ...
    <div class="x_panel">
        <div class="x_title p-3">
            ...
            <div class="header-title d-flex align-items-center gap-2">
                <h2 class="mr-auto">Yearly Bonus Count List</h2>
                <a href="{{route('yearly.bonus.create')}}" class="btn btn-md btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add Bonus Count</a>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="{{route('yearly.live.bonus.edit', $party->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit" ></i> Edit</a>
                                                @else
                                                <a href="{{route('yearly.bonus.create', $party->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-plus" ></i> Add</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
