@section('page-title', 'Monthly Bonus Count Edit')
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title p-3">
            <div class="header-title d-flex align-items-center gap-2 ">
                <h2>Monthly Bonus Count Edit</h2>
                    ...
                    <form wire:submit.prevent=store() class="form-horizontal form-label-left sales_entry_form" method="POST">
                                ...
                                <div class="row" id="row_{{$i}}">
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="monthly_bonus.{{$i}}.start" value="{{$bonus['start']}}" class="form-control text-right">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="monthly_bonus.{{$i}}.end"  value="{{$bonus['end']}}" class="form-control text-right">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="py-1 border entry-lebel sales_entry_lebel d-none" for="rate">Bonus Rate:</label>
                                            <input type="text"  wire:model="monthly_bonus.{{$i}}.rate"  value="{{$bonus['rate']}}" class="form-control text-right">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                        ...
                        <div class="item form-group">
                            <div class="col-md-12 col-sm-12 text-center">
                                ...
                                <a href="{{route('bonus.index')}}" class="btn btn-info" type="button">Cancel</a>
