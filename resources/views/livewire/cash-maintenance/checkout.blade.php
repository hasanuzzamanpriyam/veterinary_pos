    ...
    <div class="x_panel">
        <div class="x_title px-3 mt-3">
            <div class="header-title d-flex align-items-center gap-2">
                <h2 class="mr-auto">Cash Maintenance Checkout</h2>
                <a href="{{ route('cash_maintenance.create') }}" class="btn btn-secondary btn-sm cursor-pointer"><i
        ...
        <div class="x_content px-3">
            ...
            <h1 class="m-0 text-center text-dark">{{$date}}</h1>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @forelse ( $allData as $key => $items )
                                        @if($key == 'collection' || $key == 'collection_custom')
                                            @php
                                                $ex_c++;
                                            @endphp
                        ...
                        <div class="responsive-table">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    @forelse ( $allData as $key => $items )
                                    @if($key == 'payment' || $key == 'payment_custom')
                                        @php
                                            $ex_p++;
                                        @endphp
                                        @foreach ( $items as $item )
                        ...
                        <div class="responsive-table">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    @forelse ( $allData as $key => $items )
                                        @if($key == 'expense' || $key == 'expense_custom')
                                            @php
                                                $ex_e++;
                                            @endphp
                                            @foreach ( $items as $item )
            ...
            <section class="footer">
                ...
                <div class="item form-group">
                    <div class="col-md-12 col-sm-12 text-center gap-2">
                        ...
                        <a href="{{ route('cash_maintenance.create') }}" class="btn btn-warning cursor-pointer text-dark"><i
                            class="fa fa-arrow-left"></i> Edit</a>
                        <button type="button" class="btn btn-success" wire:click="store" @disabled(!$date)><i
