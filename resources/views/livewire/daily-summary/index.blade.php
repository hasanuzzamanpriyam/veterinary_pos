    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="header-title d-flex align-items-center gap-2 p-3">
                ...
                @if($date)<a href="{{route('daily.report.pdf', $date)}}" class="btn btn-info btn-link">Download <i
        ...
        <div class="x_content">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form wire:submit.prevent=dailyReportSearch()>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="daily-summary-sales-report-area mt-4">
                            <div class="x_title">
                                <h4 class="text-center"> <strong>Daily Purchase Report</strong></h4>
                            </div>
                            @if($purchase)
                                <table class="table table-striped table-bordered">
                                    <thead>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Daily Salary Expense Report</strong></h4>
                                </div>
                                @if($salary)
                                    <table class="table table-striped table-bordered">
                                        <thead>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Daily Bank Expense Report</strong></h4>
                                </div>
                                @if($bank)
                                    <table class="table table-striped table-bordered">
                                        <thead>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Daily Labour Expense Report</strong></h4>
                                </div>
                                @if($labour)
                                    <table class="table table-striped table-bordered">
                                        <thead>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Daily Carring Expense Report</strong></h4>
                                </div>
                                @if($carring)
                                    <table class="table table-striped table-bordered">
                                        <thead>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="daily-summary-sales-report-area mt-4">
                                <div class="x_title">
                                    <h4 class="text-center"> <strong>Daily Dokan Expense Report</strong></h4>
                                </div>
                                @if($dokan)
                                    <table class="table table-striped table-bordered">
                                        <thead>
