    ...
    <div class="x_panel">
        <div class="x_title p-3">
            <div class="header-title d-flex align-items-center gap-2">
                ...
                <a href="{{ route('download.supplier', ['type' => 'all', 'format' => 'excel', 'q' => $queryString ]) }}" class="btn btn-sm btn-success py-0">
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-vertical customer_diplay_list">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a href="{{route('supplier.purchase.list',['id' => $supplier->id, 'v' => 2])}}"
                                                        class="btn btn-info btn-sm w-20">Purchase List 2 <i class="fa fa-book" ></i></a></li>

                                                    <li><a href="{{route('supplier.ledger2',$supplier->id)}}"
                                                        class="btn btn-info btn-sm w-20">Ledger 2 <i class="fa fa-book" ></i></a></li>

                                                    <li><a href="{{route('supplier.statement', ['id' => $supplier->id, 'v' => 2])}}"
                                                        class="btn btn-info btn-sm w-20">Statement 2 <i class="fa fa-tasks" ></i></a></li>
