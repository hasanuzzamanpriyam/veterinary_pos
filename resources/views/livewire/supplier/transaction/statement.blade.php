...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel p-3">
        ...
        <div class="search" wire:ignore>
            <form action="{{route('supplier.transactions.statement')}}" method="get">
                                ...
                                @foreach($supplier_ledger_info as $report)
                                    ...
                                    @elseif($report->type == 'purchase')
                                        ...
                                        <tr style="background-color: #e1f3eb" data-type="purchase">
                                            ...
                                            <td class="text-left">
                                                {{'Purchase'}} -
                                                {{$report->transport_no}}{{$report->delivery_man && $report->transport_no ? ", " : ''}}{{$report->delivery_man}}
                                            </td>
                                            ...
                                            <td>
                                                @foreach ($filtered_products as $product)
                                                    @php
                                                        ...
                                                        $qty_mt += (float)($product->product->size->name ?? 0) * $product->quantity;
                                                    @endphp
                                                @endforeach
                                                @php
                                                    $total_summary['weight'] -= $qty_mt;
