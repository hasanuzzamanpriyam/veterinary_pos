                    ...
                    <div class="due-list-area">
                        ...
                        <div class="header-area">
                            <div class="banner-area">
                                <img src="{{ public_path('assets/images/firoz_header.jpg') }}" width="100%" height="120"
                                    alt="">
                            </div>
                        ...
                        @if($date)
                            <div class="header-date-area">
                                <div class="date-area">
                                    <h6 class="text-left">Date: {{date('d-m-Y', strtotime($date))}}</h6>
                                </div>
                            </div>
                        @endif
                                    ...
                                    @if(!empty($sales))
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                ...
                                                @endforelse
                                                <tr class="text-right">
                                                    <td colspan="4" class="text-right">Total Amount = {{$total_sales}} /=
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    @if(!empty($purchase))
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                ...
                                                @endforelse
                                                <tr class="text-right">
                                                    <td colspan="4" class="text-right">Total Amount = {{$total_purchase}} /=
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    @if(!empty($collection))
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                ...
                                                @endforelse
                                                <tr class="text-right">
                                                    <td colspan="4" class="text-right">Total Amount = {{$total_collection}}
                                                        /=</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    @if(!empty($payment))
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                ...
                                                @endforelse
                                                <tr class="text-right">
                                                    <td colspan="4" class="text-right">Total Amount = {{$total_payment}} /=
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        @if(!empty($salary))
                                            <table class="table ">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endforelse
                                                    <tr class="text-right">
                                                        <td colspan="4" class="text-right">Total Amount = {{$total_salary}}
                                                            /=</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        @if(!empty($bank))
                                            <table class="table ">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endforelse
                                                    <tr class="text-right">
                                                        <td colspan="2" class="text-right">Total Amount = {{$total_bank}} /=
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        @if(!empty($labour))
                                            <table class="table ">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endforelse
                                                    <tr class="text-right">
                                                        <td colspan="2" class="text-right">Total Amount = {{$total_labour}}
                                                            /=</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        @if(!empty($carring))
                                            <table class="table ">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endforelse
                                                    <tr class="text-right">
                                                        <td colspan="3" class="text-right">Total Amount = {{$total_carring}}
                                                            /=</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        @if(!empty($dokan))
                                            <table class="table ">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endforelse
                                                    <tr class="text-right">
                                                        <td colspan="3" class="text-right">Total Amount = {{$total_dokan}}
                                                            /=</td>
                                                    </tr>
                                                </tbody>
                                            </table>
