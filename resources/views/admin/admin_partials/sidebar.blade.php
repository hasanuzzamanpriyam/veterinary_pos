    ...
    <div class="menu_section">
        ...
        @role('Super Admin|Admin|Manager|Staff')
            ...
            <ul class="nav side-menu">
                ...
                <ul class="nav side-menu">
                    @role('Super Admin')
                        <li><a><i class="fa fa-shield"></i><span class="label">Role Management <span
                    ...
                    @can('customer-view')
                        <li><a><i class="fa fa-user"></i><span class="label">Customer <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('customer-create')
                                ...
                                @endcan
                                <li><a href="{{ route('customer.gallary') }}"> <i class="fa fa-users"></i> Customer Gallary</a>
                                </li>
                            </ul>
                        </li>
                    @endcan
                    ...
                    @can('supplier-view')
                        <li><a><i class="fa fa-truck"></i><span class="label">Supplier <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('supplier-create')
                    ...
                    @can('product-view')
                        <li><a><i class="fa fa-product-hunt"></i><span class="label">Product <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('product-create')
                    ...
                    @can('purchase-view')
                        <li><a><i class="fa fa-cart-plus"></i><span class="label">Purchase orders <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('purchase-create')
                                    <li><a href="{{ route('live.purchase.create') }}">Purchase Entry </a></li>
                                @endcan
                                <li><a><span class="label">Purchase List <span class="fa fa-chevron-down"></span></span></a>
                                    <ul class="nav child_menu">
                    ...
                    @can('sales-view')
                        <li><a><i class="fa fa-shopping-cart"></i><span class="label">Sales orders <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('sales-create')
                                    <li><a href="{{ route('live.sales.create') }}">Sale Entry</a></li>
                                @endcan
                                <li><a><span class="label">Sales List <span class="fa fa-chevron-down"></span></span></a>
                                    <ul class="nav child_menu">
                    ...
                    @canany(['collection-view', 'payment-view'])
                        <li><a><i class="fa fa-credit-card"></i><span class="label">Accounts <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('collection-view')
                    ...
                    @can('cash-maintenance-view')
                        <li><a><i class="fa fa-credit-card"></i><span class="label">Cash Maintenance<span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                    ...
                    @can('employee-view')
                        <li><a><i class="fa fa-users"></i><span class="label">Employee Management<span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('employee-create')
                    ...
                    @can('bonus-view')
                        <li><a><i class="fa fa-gift"></i><span class="label">Bonus Counting<span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('bonus-create')
                    ...
                    @canany(['follow-up-customer', 'follow-up-supplier'])
                        <li><a><i class="fa fa-refresh"></i><span class="label">Follow Up Date<span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                    ...
                    <li><a><i class="fa fa-quote-right"></i><span class="label">Quotations <span
                                    class="fa fa-chevron-down"></span></span></a>
                        <ul class="nav child_menu">
                    ...
                    @canany(['reports-daily', 'reports-monthly', 'reports-yearly', 'reports-profit-loss'])
                        <li><a><i class="fa fa-list-alt"></i><span class="label">Reporting and Analytics<span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                    ...
                    @can('expense-view')
                        <li><a><i class="fa fa-money"></i><span class="label">Expenses <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('expense-create')
                    ...
                    @can('bank-view')
                        <li><a><i class="fa fa-calendar"></i><span class="label"> Bank Details <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                <li>
                                    ...
                                    <ul class="nav child_menu">
                                        @can('transaction-create')
                                            <li><a href="{{ route('transaction.create', ['view' => 'deposit']) }}">Deposit</a>
                                            </li>
                                            <li><a href="{{ route('transaction.create', ['view' => 'withdraw']) }}">Withdraw</a>
                                            </li>
                                        @endcan
                                    </ul>
                    ...
                    <li><a><i class="fa fa-calendar"></i><span class="label">Due Show<span
                                    class="fa fa-chevron-down"></span></span></a>
                        <ul class="nav child_menu">
                    ...
                    @role('Super Admin|Admin')
                        <li><a><i class="fa fa-plus"></i><span class="label">Additional Add <span
                                        class="fa fa-chevron-down"></span></span></a>
                            <ul class="nav child_menu">
                                @can('store-manage')
