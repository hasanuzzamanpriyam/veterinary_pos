        ...
        <div class="x_panel">
            <div class="x_title p-3">
                <div class="header-title d-flex align-items-center gap-2 ">
                    ...
                    <a href="{{route('live.product.create')}}" class="btn btn-md btn-primary"> <i class="fa fa-plus"
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        <div class="card-box table-responsive">
                            ...
                            @endif
                            <table id="prodcutList" class="table table-striped table-bordered dt-responsive nowrap"
                                                ...
                                                <div class="btn-group btn-group-vertical customer_diplay_list">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="{{route('product.edit', $product->id)}}"
                                                                class="btn btn-success d-flex align-items-center gap-2"><i
                                                                    class="fa fa-edit"></i><span>Edit</span></a></li>
                                                        <li><a href="{{route('product.view', $product->id)}}"
                                                                class="btn btn-info d-flex align-items-center gap-2"><i
                                                                    class="fa fa-eye"></i><span>View</span></a></li>
                                                        <li> <a href="{{route('product.delete', $product->id)}}"
                                                                class="btn btn-danger d-flex align-items-center gap-2"
                                                                id="delete"><i class="fa fa-trash"></i><span>Delete</span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
