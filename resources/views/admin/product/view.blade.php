                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="back_button mb-2">
                            <a href="{{route('product.index')}}" class="btn btn-md btn-primary float-right"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="logo text-center my-3">
                            ...
                            @else
                            <img src="/public{{$product->photo}}" class="img-thumbnail img-responsive" alt="Logo" width="250" height="320">
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <table class="product-data table table-striped">
                                ...
                                @else
                                    <tr><th>Size</th><td>{{$product->size->description}}</td></tr>
                                @endif
                        </table>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <table class="product-data table table-striped">
                                ...
                                <tr><th>Available Stock</th><td>{{$item_stock}} {{trans_choice('labels.' .$product->type, $item_stock)}}</td></tr>
                                <tr><th>Metric Ton</th> <td> {{$product->size->name * $item_stock / 1000}} {{$product->metric_ton}} </td></tr>
                                <tr><th>Alert Quantity</th> <td>{{$product->alert_quantity}}</td></tr>
                                <tr><th>Purchase Value</th><td>{{formatAmount($item_stock * $product->purchase_rate)}}/-</td></tr>
                                <tr><th>Sale Value</th>  <td>{{formatAmount($item_stock * $product->price_rate)}}/-</td></tr>
                                <tr><th>MRP</th><td>{{formatAmount($item_stock * $product->mrp_rate)}}/-</td></tr>
                                <tr><th>Remarks</th><td>{{$product->remarks}}</td></tr>
                        </table>
                    </div>
                </div>
            </div>
