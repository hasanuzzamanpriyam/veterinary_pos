...
@section('main-content')
    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                <h2> <a href="{{route('product.create')}}" class="btn btn-md btn-primary">+Add Product</a> Product Stack
                    List<small>Show your product stack list from here</small></h2>
                                ...
                                <tbody>
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td> <a href="{{route('product.edit', $product->id)}}" class="btn btn-success"><i
                                                        class="fa fa-edit"></i></a> <a
                                                    href="{{route('product.delete', $product->id)}}" class="btn btn-danger"
                                                    id="delete"><i class="fa fa-trash"></i></a> <a
                                                    href="{{route('product.view', $product->id)}}" class="btn btn-info"><i
