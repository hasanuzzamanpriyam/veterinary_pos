            ...
            <form action="{{route('dokan.expense.store')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label  col-md-4 col-sm-4 label-align" for="amount">Rent Amount
                              <span class=""></span>
                            </label>
                            <div class="col-md-8 col-sm-8">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label  col-md-4 col-sm-4 label-align" for="receiving_by">Receive By<span class=""></span>
                            </label>
                            <div class="col-md-8 col-sm-8">
