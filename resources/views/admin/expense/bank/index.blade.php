    ...
    <div class="x_panel">
        <div class="x_title p-3">
            ...
            <div class="header-title d-flex align-items-center gap-2">
                <h2 class="mr-auto">Bank expenses List</h2>
                <a href="{{route('bank.expense.create')}}" class="btn btn-md btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add Bank Expense</a>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td class="text-right">{{$expense->other_charge}}</td>
