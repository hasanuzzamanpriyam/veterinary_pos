            ...
            <form action="{{route('bank.expense.update')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="item form-group">
                            <label class="col-form-labelcol-md-4 col-sm-4 label-align" for="voucher_no">Voucher No<span class=""></span>
                            </label>
                            <div class="col-md-8 col-sm-8">
                        ...
                        <div class="item form-group">
                            <label class="col-form-labelcol-md-4 col-sm-4 label-align" for="bank_name">Bank Name

                            </label>
                            <div class="col-md-8 col-sm-8">
                                <select type="text" name="id_no" id="id_no" class="form-control">
                                    @foreach ($banks as $bank)
                                        <option value="{{$bank->id}}" @if($bank_expense->id_no == $bank->id) selected="" @endif>{{$bank->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input type="text" id="amount" onkeyup="amoutCalculation()" name="amount" value="{{$bank_expense->amount}}" class="form-control" >
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 col-sm-8">
                                <div class="row">
                                    <div class="col-7 pr-1">
                                        <select type="text" id="amount_month" name="amount_month" value="{{$bank_expense->amount_month}}" class="form-control" >
                                            <option value="">Select Option</option>
                                            @foreach($months as $amount_month)
                                                <option value="{{$amount_month}}" @if($bank_expense->amount_month == $amount_month) selected @endif>{{$amount_month}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-5 ml-0 pl-0">
                                        <select type="text" id="year" name="year" class="form-control" >
                                            ...
                                            @foreach($years as $year)
                                                <option value="{{$year}}" @if($year==$bank_expense->year) selected @endif>{{$year}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input type="text" id="other_charge" onkeyup="amoutCalculation()" name="other_charge" value="{{$bank_expense->other_charge}}" class="form-control" >
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <textarea type="text" name="remarks" id="remarks" cols="10" rows="1"  class="form-control">{{$bank_expense->remarks}}</textarea>
