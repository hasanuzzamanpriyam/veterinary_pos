    ...
    <div class="x_panel">
        <div class="x_title p-3">
            ...
            <div class="header-title d-flex align-items-center gap-2">
                <h2 class="mr-auto">Carring expenses List</h2>
                <a href="{{route('carring.expense.create')}}" class="btn btn-md btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add Carring Expense</a>
            </div>
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap category_list_table" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <th class="all">Delivary Point</th>
