    ...
    <div class="x_panel">
        <div class="x_title p-3">
            <div class="header-title d-flex align-items-center gap-2">
                <h2>Employee Payment Invoice</h2>
            ...
            <div class="row">
                    ...
                    <div class="product-list-area">
                        <table class="table table-bordered table-striped table-sm">
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center comon_column">{{ date('d-m-Y', strtotime($invoice->updated_at)) }}</td>
                                    <td class="text-center comon_column"> {{ ucfirst($invoice->payment_method) }}</td>
                                    <td class="text-center comon_column">{{ ucfirst($invoice->remarks) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="calculation-area d-flex justify-content-end">
                        @php
                            $prev_due = $invoice->type == 'salary' ? $invoice->balance - $invoice->amount : $invoice->balance + $invoice->amount;
                        @endphp
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="in-word-area">
                        <h4 class="text-left text-dark">In Words:
                            <span> {{ numberToWords($invoice->amount) }}</span>
                        </h4>
                    </div>
                </div>
                            ...
                            <div class="bottom-area py-3">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="customer-signature-area">
                                        <h4 class="text-center text-dark">Employee Signature</h4>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6">
