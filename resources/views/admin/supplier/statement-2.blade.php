                            ...
                            @foreach ($supplier_ledger_info as $report)
                                @if( $report->type == 'other' )
                                    <tr data-type="other">
                                        ...
                                        <td class="text-left">{{$report->payment_remarks}}</td>
                                        <td class=""></td>
                                        <td class=""></td>
                                        <td class=""></td>
                                        <td class=""></td>
                                ...
                                @elseif( $report->type == 'return' )
                                    ...
                                    <tr style="background-color: #f3e1e1" data-type="return">
                                        {{-- Date --}}
                                        <td class=""><span class="d-block text-nowrap">{{date('d-m-Y', strtotime($report->date))}}</span></td>
                                        {{-- Invoice --}}
                                        <td class="text-center">{{$report->id}}</td>
                                        {{-- Description --}}
                                        <td class="text-left">
                                        ...
                                        {{-- Dis. (TK) --}}
                                        <td class="text-right">{{$report->price_discount ? number_format($report->price_discount) . '/=' : ''}}</td>

                                        {{-- Return (TK) --}}
                                        <td class="text-right">{{$report->total_price ? number_format($report->total_price) . '/=' : ''}}</td>

                                        {{-- Total (TK) --}}
                                        <td class="text-right">-{{number_format($report->total_price)}}/=</td>

                                        {{-- VAT --}}
                                        <td class="text-right">{{$report->vat ? number_format($report->vat) . '/=' : ''}}</td>

                                        {{-- Carring --}}
                                        <td class="text-right">{{$report->carring ? number_format($report->carring) . '/=' : ''}}</td>

                                        {{-- Other Charge --}}
                                        <td class="text-right">{{$report->other_charge ? number_format($report->other_charge) . '/=' : ''}}</td>
