            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card-box purchase-list table-responsive">
                        <form action="{{route('supplier.purchase.list', ['id' => $supplier->id])}}" data-parsley-validate
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-6">
                                    <div class="form-group">
                                        <a type="button" href="{{ route('supplier.purchase.list', ['id' => $supplier->id, 'v' => 2]) }}"
                            ...
                            <tbody>
                                ...
                                @foreach($supplier_ledgers as $purchase)
                                    ...
                                    <tr data-type={{$t_type}} style="background-color: {{$row_bg}}">
                                        ...
                                        <td class="text-left">
                                            @if ($t_type == "purchase")
                                                {{$purchase->transport_no}}{{$purchase->delivery_man && $purchase->transport_no ? ", " : ''}}{{$purchase->delivery_man}}
                                        ...
                                        <td class="text-center">
                                            @if($t_type == "purchase" && isset($qty_summary['total']))
                                        ...
                                        {{-- Return Qty --}}
                                        <td class="text-center">
                                            @if($t_type == "return" && isset($qty_summary['total']))
                                                @foreach ($qty_summary['total'] as $type => $qty)
                                                    {{$qty > 0 ? $qty . ' ' . trans_choice('labels.' . $type, $qty) : ''}}
                                                @endforeach
                                            @endif
                                        ...
                                        {{-- Return --}}
                                        <td class="text-right">{{$qty_summary['return_value'] > 0 ? number_format($qty_summary['return_value']) . '/=' : ''}}</td>

                                        {{-- Dis. Tk --}}
                                        <td class="text-right">
                                            @if($purchase->price_discount)
                                                {{number_format($purchase->price_discount)}}/=
                                            @endif
                                        </td>
