                                    ...
                                    @forelse ($products as $product)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center p-1">
                                                {{ $product->product->barcode ?? $product->product_code }}</td>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="calculation-area d-flex justify-content-end">
                            @php
                                ...
                                $gTotal =
                                    $supplier_info->total_price -
                                    $supplier_info->price_discount -
                                    $supplier_info->vat -
                                    $supplier_info->carring -
                                    $supplier_info->other_charge;
                                $prev_balance =
                                    $supplier_info->balance != 0
                                        ? $supplier_info->balance + $supplier_info->payment - $gTotal
                                        : 0;
                            @endphp
