                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-left p-0 comon_column">
                                            ...
                                            $supplier_ledger->delivery_man : ''}}</td>
                                        <td class="text-left p-0 comon_column">{{$supplier_ledger->supplier_remarks}}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="text-right p-1 comon_column">
                                            {{number_format($total_summary['sub_total'])}}/=</th>
                                    </tr>
                                </tfoot>
                                @endif
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="calculation-area d-flex justify-content-end">
                            ...
                            <table class="calculation_below_table">
                                <tr>
                                    <th>Total Price</th>
                                    <td>{{number_format($supplier_ledger->total_price)}}/=</td>
                                </tr>
                                @if($supplier_ledger->carring)
                                <tr>
                                    <th>Carring</th>
                                    <td>{{number_format($supplier_ledger->carring)}}/=</td>
                                </tr>
                                @endif
                                @if ($supplier_ledger->other_charge)
                                <tr>
                                    <th>Others</th>
                                    <td>{{number_format($supplier_ledger->other_charge)}}/=</td>
                                </tr>
                                @endif
                                @php
                                $total = $supplier_ledger->total_price -
                                ($supplier_ledger->carring+$supplier_ledger->other_charge);
                                @endphp
                                <tr>
                                    <th>Grand Total</th>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="thanks-area">
                                <h5 class="text-center text-dark text-center m-0"><small>Thank you for shopping with
                                        us</small></h5>
                            </div>
                        </div>
                    </div>
