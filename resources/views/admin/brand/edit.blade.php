...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            @endif
            <form action="{{route('brand.update')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
                <div class="row m-auto">
                    <div class="col-12">

                        <div class="item form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align" for="name">Brand Name <span class=""></span>
                            </label>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <textarea type="text" name="description" id="description" cols="10" rows="1" ="" class="form-control">{{$brand->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <textarea type="text" name="remarks" id="remarks" cols="10" rows="1"  class="form-control">{{$brand->remarks}}</textarea>
                            </div>
                        </div>
