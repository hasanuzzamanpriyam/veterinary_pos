...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            @endif
            <form action="{{route('bank.add')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align add_bank_lebel" for="title">AC Mode<span class=""></span>
                            </label>
                            <div class="col-md-8 col-sm-8">
                                <input type="text" id="ac_mode" name="ac_mode"  class="form-control" placeholder="">
                            </div>
                        </div>
