...
class SuppliersList extends Component
{
    ...
    public function downloadPdf()
    {
        $query = Supplier::with(['ledgers' => function ($query) {
            ...
            ->where('company_name', 'LIKE', "%$this->queryString%")
        ...
        $html = view(
            'admin.download.supplier.pdf.supplier-list',
            [
    ...
    public function render()
    {
        ...
        return view('livewire.supplier.suppliers-list', get_defined_vars())
